...
mix.js('resources/js/app.js', 'public/js')
    ...
    .css('resources/css/admin/form.css', 'public/css')
    .js('node_modules/popper.js/dist/popper.js', 'public/js')
    .js('resources/js/admin/user/index.js', 'public/js/admin/user')
    .js('resources/js/admin/user/index_2.js', 'public/js/admin/user')
    ...
    .js('resources/js/admin/product/form.js', 'public/js/admin/product')
    .sourceMaps();
